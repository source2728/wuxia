...
public class UIPupilListView : ViewWin<UI_PupilListView>
{
    public UIPupilListView()
    {
    ...
    {
        base.OnInit();
        m_UI.m_BtnBack.onClick.AddCapture(ViewBack);
    ...
    private void OnSelectPupil(EventContext context)
    {
        ...
        WinCenter.inst.TransView<UIPupilView>(id);
    }
}
